...
.how-it-works strong {
    ...
    <p>Standard car driving lessons for Code 08 licence</p>
        ...
        <!-- COURSE GRID (CODE 10 EXAMPLE) -->
          <section class="hero-10">
    <h2>CODE 10 - Light Truck</h2>
    <p>Professional truck driving lessons for Code 10 licence</p>
</section>
        ...
        <section class="course-grid container fade-in">
            ...
            <div class="course-card">
                <div class="icon">&#128656;</div>
                <h3>Princess's Package - 25 Lessons</h3>
                <p>CODE 10 - Light Truck</p>
                <p>R3000.00</p>
...
<section class="how-it-works">
    ...
    <script>
        // Scroll reveal animation for course cards
